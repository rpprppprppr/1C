...
Функция СвойстваНоменклатуры(Номенклатура)
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	УдалитьНоменклатура.ВидАттракциона,
		|	УдалитьНоменклатура.КоличествоПосещений
		|ИЗ
		|	Справочник.УдалитьНоменклатура КАК УдалитьНоменклатура
		|ГДЕ
		|	УдалитьНоменклатура.Ссылка = &Ссылка";
